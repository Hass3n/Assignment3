namespace Assignment3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //    Console.WriteLine("max element is " + numberOne);
            //    if (numberTwo > numberThree)
            //        Console.WriteLine("MIN number " + numberThree);
            //    else
            ...
            //        Console.WriteLine("MIN number " + numberThree);
            //    else
            //        Console.WriteLine("MIN number " + numberOne);

            //}

            //else
            //{
            //    Console.WriteLine("max element is " + numberThree);
